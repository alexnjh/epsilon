...
<dl>
  ...
  In order to add a new scheduler plugin, follow the steps shown below
      ...
      5. Open /framework/v1alpha1/framework.go and add the plugin into the correct plugin list. Each list is for a different stage, make sure to add the new plugin to the correct list
