...
func RetryProcess(comm Communication, msgs <-chan amqp.Delivery, closed chan<- bool){
...
func WaitAndSend(comm Communication, obj RetryRequest, duration time.Duration){
